...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tournaments_game', 'winner_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='game_wins', null=True, to=orm['profiles.Profile']), keep_default=False)

        # Adding field 'Game.loser'
        db.add_column('tournaments_game', 'loser', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='game_losses', null=True, to=orm['profiles.Profile']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Game.loser'
        db.delete_column('tournaments_game', 'loser_id')
    ...
    models = {
        ...
        'tournaments.game': {
            ...
            'winner_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'game_wins'", 'null': 'True', 'to': "orm['profiles.Profile']"})
        },
        'tournaments.map': {
