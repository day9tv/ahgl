...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TournamentRound.published'
        db.add_column('tournaments_tournamentround', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TournamentRound.published'
        db.delete_column('tournaments_tournamentround', 'published')
