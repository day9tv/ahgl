...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Map.photo'
        db.add_column('tournaments_map', 'photo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Map.photo'
        db.delete_column('tournaments_map', 'photo')
