...
class Migration(SchemaMigration):
    depends_on = (
        ("profiles", "0023_auto__del_field_profile_bnet_profile__del_field_profile_char_code__del"),
    )

    def forwards(self, orm):
        
        # Adding field 'Game.home_player_tmp'
        db.add_column('tournaments_game', 'home_player_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='home_games_tmp', null=True, to=orm['profiles.Profile']), keep_default=False)

        # Adding field 'Game.away_player_tmp'
        db.add_column('tournaments_game', 'away_player_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='away_games_tmp', null=True, to=orm['profiles.Profile']), keep_default=False)

        # Adding field 'Game.winner_tmp'
        db.add_column('tournaments_game', 'winner_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='game_wins_tmp', null=True, to=orm['profiles.Profile']), keep_default=False)

        # Adding field 'Game.loser_tmp'
        db.add_column('tournaments_game', 'loser_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='game_losses_tmp', null=True, to=orm['profiles.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.home_player_tmp'
        db.delete_column('tournaments_game', 'home_player_tmp_id')

        # Deleting field 'Game.away_player_tmp'
        db.delete_column('tournaments_game', 'away_player_tmp_id')

        # Deleting field 'Game.winner_tmp'
        db.delete_column('tournaments_game', 'winner_tmp_id')

        # Deleting field 'Game.loser_tmp'
        db.delete_column('tournaments_game', 'loser_tmp_id')
    ...
    models = {
        ...
        'tournaments.game': {
            ...
            'away_player_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'away_games_tmp'", 'null': 'True', 'to': "orm['profiles.Profile']"}),
            ...
            'home_player_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'home_games_tmp'", 'null': 'True', 'to': "orm['profiles.Profile']"}),
            ...
            'loser_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'game_losses_tmp'", 'null': 'True', 'to': "orm['profiles.Profile']"}),
            ...
            'winner_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'game_wins_tmp'", 'null': 'True', 'to': "orm['profiles.Profile']"})
        },
