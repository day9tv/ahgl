...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.status'
        db.add_column('tournaments_tournament', 'status', self.gf('django.db.models.fields.CharField')(default='S', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tournament.status'
        db.delete_column('tournaments_tournament', 'status')
