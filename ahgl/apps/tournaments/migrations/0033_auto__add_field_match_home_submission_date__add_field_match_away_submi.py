...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.home_submission_date'
        db.add_column('tournaments_match', 'home_submission_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Match.away_submission_date'
        db.add_column('tournaments_match', 'away_submission_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.home_submission_date'
        db.delete_column('tournaments_match', 'home_submission_date')

        # Deleting field 'Match.away_submission_date'
        db.delete_column('tournaments_match', 'away_submission_date')
