...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.games_per_match'
        db.add_column('tournaments_tournament', 'games_per_match', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tournament.games_per_match'
        db.delete_column('tournaments_tournament', 'games_per_match')
