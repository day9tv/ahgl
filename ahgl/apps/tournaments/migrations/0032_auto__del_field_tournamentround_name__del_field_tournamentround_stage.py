...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TournamentRound.name'
        db.delete_column('tournaments_tournamentround', 'name')

        # Deleting field 'TournamentRound.stage'
        db.delete_column('tournaments_tournamentround', 'stage')


    def backwards(self, orm):
        
        # Adding field 'TournamentRound.name'
        db.add_column('tournaments_tournamentround', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)

        # Adding field 'TournamentRound.stage'
        db.add_column('tournaments_tournamentround', 'stage', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
