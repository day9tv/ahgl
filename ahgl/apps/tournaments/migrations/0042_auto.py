...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Tournament', fields ['status']
        db.create_index('tournaments_tournament', ['status'])


    def backwards(self, orm):
        
        # Removing index on 'Tournament', fields ['status']
        db.delete_index('tournaments_tournament', ['status'])
