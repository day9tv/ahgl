...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.tournament_round'
        db.add_column('tournaments_match', 'tournament_round', self.gf('django.db.models.fields.related.ForeignKey')(related_name='matches', null=True, to=orm['tournaments.TournamentRound']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Match.tournament_round'
        db.delete_column('tournaments_match', 'tournament_round_id')
