...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tournaments_game', 'winner')


    def backwards(self, orm):
        
        # Adding field 'Game.winner'
        db.add_column('tournaments_game', 'winner', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)
