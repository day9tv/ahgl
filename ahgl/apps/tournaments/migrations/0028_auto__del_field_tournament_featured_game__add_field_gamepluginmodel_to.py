...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GamePluginModel.tournament'
        db.add_column('cmsplugin_gamepluginmodel', 'tournament', self.gf('django.db.models.fields.related.ForeignKey')(default='starcraft-2-season-2', to=orm['tournaments.Tournament']), keep_default=False)

        # Changing field 'GamePluginModel.game'
        db.alter_column('cmsplugin_gamepluginmodel', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Game'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GamePluginModel.tournament'
        db.delete_column('cmsplugin_gamepluginmodel', 'tournament_id')

        # Changing field 'GamePluginModel.game'
        db.alter_column('cmsplugin_gamepluginmodel', 'game_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournaments.Game']))
