...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('tournaments_game', 'winner_tmp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_wins_tmp', null=True, to=orm['profiles.Profile'], blank=True), keep_default=False)

        # Adding field 'Game.loser_tmp'
        db.add_column('tournaments_game', 'loser_tmp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='game_losses_tmp', null=True, to=orm['profiles.Profile'], blank=True), keep_default=False)

        # Adding field 'Game.home_player_tmp'
        db.add_column('tournaments_game', 'home_player_tmp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='home_games_tmp', null=True, to=orm['profiles.Profile'], blank=True), keep_default=False)

        # Adding field 'Game.away_player_tmp'
        db.add_column('tournaments_game', 'away_player_tmp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='away_games_tmp', null=True, to=orm['profiles.Profile'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'tournaments.game': {
            ...
            'away_player': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'away_games'", 'null': 'True', 'to': "orm['profiles.TeamMembership']"}),
            ...
            'home_player': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'home_games'", 'null': 'True', 'to': "orm['profiles.TeamMembership']"}),
            ...
            'loser': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'game_losses'", 'null': 'True', 'to': "orm['profiles.TeamMembership']"}),
            ...
            'winner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'game_wins'", 'null': 'True', 'to': "orm['profiles.TeamMembership']"}),
