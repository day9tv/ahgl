...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tournament.active'
        db.delete_column('tournaments_tournament', 'active')


    def backwards(self, orm):
        
        # Adding field 'Tournament.active'
        db.add_column('tournaments_tournament', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
