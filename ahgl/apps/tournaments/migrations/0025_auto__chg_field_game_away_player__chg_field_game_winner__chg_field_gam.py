...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Game.away_player'
        db.alter_column('tournaments_game', 'away_player_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Profile']))

        # Changing field 'Game.winner'
        db.alter_column('tournaments_game', 'winner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Profile']))

        # Changing field 'Game.home_player'
        db.alter_column('tournaments_game', 'home_player_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Profile']))

        # Changing field 'Game.loser'
        db.alter_column('tournaments_game', 'loser_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.Profile']))
