...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Game.vod'
        db.alter_column('tournaments_game', 'vod', self.gf('django.db.models.fields.URLField')(default='', max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Game.vod'
        db.alter_column('tournaments_game', 'vod', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
