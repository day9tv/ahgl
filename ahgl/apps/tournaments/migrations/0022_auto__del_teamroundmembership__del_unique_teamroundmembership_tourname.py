...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GamePluginModel'
        db.create_table('cmsplugin_gamepluginmodel', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Game'])),
        ))
        db.send_create_signal('tournaments', ['GamePluginModel'])

        # Adding model 'TournamentPluginModel'
        db.create_table('cmsplugin_tournamentpluginmodel', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('tournament', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tournaments.Tournament'])),
        ))
        db.send_create_signal('tournaments', ['TournamentPluginModel'])


    def backwards(self, orm):
        
        # Deleting model 'GamePluginModel'
        db.delete_table('cmsplugin_gamepluginmodel')

        # Deleting model 'TournamentPluginModel'
        db.delete_table('cmsplugin_tournamentpluginmodel')
