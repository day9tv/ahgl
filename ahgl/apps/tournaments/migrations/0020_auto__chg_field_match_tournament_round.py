...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.tournament_round'
        db.alter_column('tournaments_match', 'tournament_round_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tournaments.TournamentRound']))


    def backwards(self, orm):
        
        # Changing field 'Match.tournament_round'
        db.alter_column('tournaments_match', 'tournament_round_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['tournaments.TournamentRound']))
