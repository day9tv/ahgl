...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tournaments_game', 'winner', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='game_wins', null=True, to=orm['profiles.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.winner'
        db.delete_column('tournaments_game', 'winner_id')
