...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tournament.structure'
        db.add_column('tournaments_tournament', 'structure', self.gf('django.db.models.fields.CharField')(default='I', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Tournament.structure'
        db.delete_column('tournaments_tournament', 'structure')
