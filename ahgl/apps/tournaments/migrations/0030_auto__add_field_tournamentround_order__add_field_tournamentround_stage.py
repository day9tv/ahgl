...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TournamentRound.order'
        db.add_column('tournaments_tournamentround', 'order', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'TournamentRound.stage_order'
        db.add_column('tournaments_tournamentround', 'stage_order', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'TournamentRound.stage_name'
        db.add_column('tournaments_tournamentround', 'stage_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TournamentRound.order'
        db.delete_column('tournaments_tournamentround', 'order')

        # Deleting field 'TournamentRound.stage_order'
        db.delete_column('tournaments_tournamentround', 'stage_order')

        # Deleting field 'TournamentRound.stage_name'
        db.delete_column('tournaments_tournamentround', 'stage_name')
