...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_charity', 'name', self.gf('django.db.models.fields.CharField')(max_length=60))


    def backwards(self, orm):
        
        # Changing field 'Charity.name'
        db.alter_column('profiles_charity', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
