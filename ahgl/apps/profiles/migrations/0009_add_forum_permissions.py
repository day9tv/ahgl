...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            add_post_permission = orm['auth.Permission'].objects.get(codename='add_post',
                                                                     content_type=orm['contenttypes.ContentType'].objects.get(app_label='pybb', model='post'))
            add_topic_permission = orm['auth.Permission'].objects.get(codename='add_topic',
                                                                     content_type=orm['contenttypes.ContentType'].objects.get(app_label='pybb', model='topic'))
