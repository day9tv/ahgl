...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_team', 'charity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teams', null=True, to=orm['profiles.Charity']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.charity'
        db.delete_column('profiles_team', 'charity_id')
