...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Team.charity'
        db.delete_column('profiles_team', 'charity')


    def backwards(self, orm):
        
        # Adding field 'Team.charity'
        db.add_column('profiles_team', 'charity', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
