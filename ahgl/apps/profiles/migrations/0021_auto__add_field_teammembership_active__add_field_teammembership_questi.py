...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamMembership.active'
        db.add_column('profiles_team_members', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'TeamMembership.questions_answers'
        db.add_column('profiles_team_members', 'questions_answers', self.gf('profiles.fields.HTMLField')(default='', blank=True), keep_default=False)

        # Adding field 'TeamMembership.char_name'
        db.add_column('profiles_team_members', 'char_name', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'TeamMembership.char_code'
        db.add_column('profiles_team_members', 'char_code', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TeamMembership.game_profile'
        db.add_column('profiles_team_members', 'game_profile', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'TeamMembership.race'
        db.add_column('profiles_team_members', 'race', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'TeamMembership.champion'
        db.add_column('profiles_team_members', 'champion', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeamMembership.active'
        db.delete_column('profiles_team_members', 'active')

        # Deleting field 'TeamMembership.questions_answers'
        db.delete_column('profiles_team_members', 'questions_answers')

        # Deleting field 'TeamMembership.char_name'
        db.delete_column('profiles_team_members', 'char_name')

        # Deleting field 'TeamMembership.char_code'
        db.delete_column('profiles_team_members', 'char_code')

        # Deleting field 'TeamMembership.game_profile'
        db.delete_column('profiles_team_members', 'game_profile')

        # Deleting field 'TeamMembership.race'
        db.delete_column('profiles_team_members', 'race')

        # Deleting field 'TeamMembership.champion'
        db.delete_column('profiles_team_members', 'champion')
    ...
    models = {
        ...
        'profiles.teammembership': {
            'Meta': {'unique_together': "(('team', 'profile'),)", 'object_name': 'TeamMembership', 'db_table': "'profiles_team_members'"},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'game_profile': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'champion': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'char_code': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'char_name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
