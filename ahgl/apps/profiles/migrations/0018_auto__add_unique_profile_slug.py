...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Profile', fields ['slug']
        db.create_unique('profiles_profile', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Profile', fields ['slug']
        db.delete_unique('profiles_profile', ['slug'])
