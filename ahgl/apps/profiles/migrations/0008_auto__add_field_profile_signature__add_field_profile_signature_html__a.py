...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'signature', self.gf('django.db.models.fields.TextField')(default='', max_length=1024, blank=True), keep_default=False)

        # Adding field 'Profile.signature_html'
        db.add_column('profiles_profile', 'signature_html', self.gf('django.db.models.fields.TextField')(default='', max_length=1054, blank=True), keep_default=False)

        # Adding field 'Profile.time_zone'
        db.add_column('profiles_profile', 'time_zone', self.gf('django.db.models.fields.FloatField')(default=3.0), keep_default=False)

        # Adding field 'Profile.language'
        db.add_column('profiles_profile', 'language', self.gf('django.db.models.fields.CharField')(default='English', max_length=10, blank=True), keep_default=False)

        # Adding field 'Profile.show_signatures'
        db.add_column('profiles_profile', 'show_signatures', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Profile.post_count'
        db.add_column('profiles_profile', 'post_count', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)

        # Adding field 'Profile.avatar'
        db.add_column('profiles_profile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.autosubscribe'
        db.add_column('profiles_profile', 'autosubscribe', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.signature'
        db.delete_column('profiles_profile', 'signature')

        # Deleting field 'Profile.signature_html'
        db.delete_column('profiles_profile', 'signature_html')

        # Deleting field 'Profile.time_zone'
        db.delete_column('profiles_profile', 'time_zone')

        # Deleting field 'Profile.language'
        db.delete_column('profiles_profile', 'language')

        # Deleting field 'Profile.show_signatures'
        db.delete_column('profiles_profile', 'show_signatures')

        # Deleting field 'Profile.post_count'
        db.delete_column('profiles_profile', 'post_count')

        # Deleting field 'Profile.avatar'
        db.delete_column('profiles_profile', 'avatar')

        # Deleting field 'Profile.autosubscribe'
        db.delete_column('profiles_profile', 'autosubscribe')
