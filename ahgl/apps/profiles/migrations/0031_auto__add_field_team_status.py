...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_team', 'status', self.gf('django.db.models.fields.CharField')(default='R', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.status'
        db.delete_column('profiles_team', 'status')
