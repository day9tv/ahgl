...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('profiles_team', 'captain_id')


    def backwards(self, orm):
        
        # Adding field 'Team.captain'
        db.add_column('profiles_team', 'captain', self.gf('django.db.models.fields.related.ForeignKey')(related_name='captain_of', null=True, to=orm['profiles.Profile'], blank=True), keep_default=False)
