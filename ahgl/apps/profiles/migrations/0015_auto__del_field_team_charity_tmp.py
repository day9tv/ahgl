...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('profiles_team', 'charity_tmp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='teams_tmp', null=True, to=orm['profiles.Charity'], blank=True), keep_default=False)
