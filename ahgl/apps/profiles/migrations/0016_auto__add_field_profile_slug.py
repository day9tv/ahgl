...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'slug', self.gf('django.db.models.fields.SlugField')(default='a', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.slug'
        db.delete_column('profiles_profile', 'slug')
