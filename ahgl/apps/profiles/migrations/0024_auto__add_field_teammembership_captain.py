...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamMembership.captain'
        db.add_column('profiles_team_members', 'captain', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TeamMembership.captain'
        db.delete_column('profiles_team_members', 'captain')
