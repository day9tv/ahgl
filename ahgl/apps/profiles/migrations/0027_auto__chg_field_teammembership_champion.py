...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamMembership.champion'
        db.alter_column('profiles_team_members', 'champion', self.gf('django.db.models.fields.CharField')(max_length=60))


    def backwards(self, orm):
        
        # Changing field 'TeamMembership.champion'
        db.alter_column('profiles_team_members', 'champion', self.gf('django.db.models.fields.CharField')(max_length=20))
