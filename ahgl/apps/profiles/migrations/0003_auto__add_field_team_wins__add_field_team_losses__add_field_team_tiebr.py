...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_team', 'wins', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Team.losses'
        db.add_column('profiles_team', 'losses', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Team.tiebreaker'
        db.add_column('profiles_team', 'tiebreaker', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Profile.questions_answers'
        db.alter_column('profiles_profile', 'questions_answers', self.gf('profiles.fields.HTMLField')())


    def backwards(self, orm):
        
        # Deleting field 'Team.wins'
        db.delete_column('profiles_team', 'wins')

        # Deleting field 'Team.losses'
        db.delete_column('profiles_team', 'losses')

        # Deleting field 'Team.tiebreaker'
        db.delete_column('profiles_team', 'tiebreaker')

        # Changing field 'Profile.questions_answers'
        db.alter_column('profiles_profile', 'questions_answers', self.gf('django.db.models.fields.TextField')())
