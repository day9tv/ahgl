...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('profiles_team', 'photo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'Profile.photo'
        db.alter_column('profiles_profile', 'photo', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))

        # Changing field 'Profile.custom_thumb'
        db.alter_column('profiles_profile', 'custom_thumb', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'Team.photo'
        db.alter_column('profiles_team', 'photo', self.gf('imagekit.models.ProcessedImageField')(max_length=100, null=True))

        # Changing field 'Profile.photo'
        db.alter_column('profiles_profile', 'photo', self.gf('imagekit.models.ProcessedImageField')(max_length=100, null=True))

        # Changing field 'Profile.custom_thumb'
        db.alter_column('profiles_profile', 'custom_thumb', self.gf('imagekit.models.ProcessedImageField')(max_length=100, null=True))
