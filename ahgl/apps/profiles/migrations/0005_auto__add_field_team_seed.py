...
class Migration(SchemaMigration):
    depends_on = (
        ("tournaments", "0010_auto__del_field_game_winner_tmp"),
    )

    def forwards(self, orm):
        
        # Adding field 'Team.seed'
        db.add_column('profiles_team', 'seed', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Team.seed'
        db.delete_column('profiles_team', 'seed')
