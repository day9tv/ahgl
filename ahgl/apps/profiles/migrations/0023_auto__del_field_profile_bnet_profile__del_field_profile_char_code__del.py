...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.bnet_profile'
        db.delete_column('profiles_profile', 'bnet_profile')

        # Deleting field 'Profile.char_code'
        db.delete_column('profiles_profile', 'char_code')

        # Deleting field 'Profile.questions_answers'
        db.delete_column('profiles_profile', 'questions_answers')

        # Deleting field 'Profile.race'
        db.delete_column('profiles_profile', 'race')

        # Deleting field 'Profile.char_name'
        db.delete_column('profiles_profile', 'char_name')


    def backwards(self, orm):
        
        # Adding field 'Profile.bnet_profile'
        db.add_column('profiles_profile', 'bnet_profile', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.char_code'
        db.add_column('profiles_profile', 'char_code', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Profile.questions_answers'
        db.add_column('profiles_profile', 'questions_answers', self.gf('profiles.fields.HTMLField')(default='', blank=True), keep_default=False)

        # Adding field 'Profile.race'
        db.add_column('profiles_profile', 'race', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.char_name'
        db.add_column('profiles_profile', 'char_name', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
