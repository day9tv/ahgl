...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('profiles_charity', (
        ...
        db.send_create_signal('profiles', ['Charity'])

        # Adding field 'Team.charity_tmp'
        db.add_column('profiles_team', 'charity_tmp', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='teams', null=True, to=orm['profiles.Charity']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Charity'
        db.delete_table('profiles_charity')

        # Deleting field 'Team.charity_tmp'
        db.delete_column('profiles_team', 'charity_tmp_id')
    ...
    models = {
        ...
        'profiles.team': {
            ...
            'charity_tmp': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'teams'", 'null': 'True', 'to': "orm['profiles.Charity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
