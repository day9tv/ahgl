...
from apps.profiles.views import TeamListView, TeamDetailView, StandingsView, TeamUpdateView, MyProfileDetailView
from apps.tournaments.views import TournamentDetailView, MatchDetailView, MatchListView, MatchReportView, MatchReportListView, SubmitLineupView, LineupView, MapListView, GameListView
